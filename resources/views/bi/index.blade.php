<x-app-layout>
    <div class="mx-auto px-4 py-4 sm:px-4 lg:px-6 w-full max-h-[calc(100vh-200px)] overflow-y-auto">
        <div class="bg-white overflow-x-auto shadow-lg rounded-lg overflow-y-auto mt-4 p-2">
            @if (Auth::user()->hasRole('admin'))
                @livewire('month-dashboard')
            @else
                <svg fill="#000000" height="200px" width="200px" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 460 460"
                    xml:space="preserve">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <g id="XMLID_520_">
                            <circle id="XMLID_904_" cx="136.16" cy="46.037" r="44.838"></circle>
                            <path id="XMLID_910_"
                ...
                <h1 class="text-center mt-2">Pagina en Mantenimiento</h1>
            @endif
        </div>
    </div>
</x-app-layout>
