                    ...
                    <form id="form" action="{{ route('excel.import-model') }}" method="post"
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div id="drop-area"
                                    class="mt-1 flex items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                    <div class="space-y-1 text-center">
                                        <svg id="file-icon" class="mx-auto text-gray-400" stroke="currentColor"
                                            fill="none" viewBox="0 0 48 48" aria-hidden="true" width="64"
                                            height="64">
                                            <path
                                        ...
                                        <p class="pl-1 dark:text-gray-100">Seleccionar archivo o arrastrar y soltar</p>
                                        <p id="file-name" class="text-gray-500">
                                            Máximo: 10 mb.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="separator" id="separator" placeholder="Ej: ," maxlength="1" autocomplete="off"
