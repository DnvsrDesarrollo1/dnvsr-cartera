...
>
    ...
    <div
        ...
        class="absolute z-10 right-0 mt-2 rounded-md dark:bg-pg-primary-700 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none border border-gray-300"
        tabindex="-1"
