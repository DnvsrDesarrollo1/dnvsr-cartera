<div x-data="{ voucherModal: @entangle('voucherModal') }">
    ...
    <div x-show="voucherModal" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
        ...
        <div class="bg-white overflow-hidden rounded-lg transform transition-all sm:max-w-3xl sm:w-full m-4">
                    ...
                    <div class="overflow-x-auto">
                        <form wire:submit.prevent="save">
                            <div class="mb-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div>
                                    <label for="numpago" class="block text-gray-700 text-sm font-bold mb-2">N° de
                                        Cuota:</label>
                                ...
                                <div class="flex items-center justify-center">
                                    <span class="text-gray-700 text-sm font-bold mb-2 p-2 border-2 border-gray-500">
                                        Se asignará a: {{ $numprestamo }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="border-l-4 border-green-600 pl-4">
                                ...
                                <span class="block text-gray-400 text-xs mb-2 italic text-center animate-pulse">
                                    Usar este campo para ACTUALIZAR el plan de pagos de acuerdo al SALDO
                                    ({{ number_format($beneficiario->saldo_credito - $capital, 2) }})
                                </span>
                                <hr class="mt-4 mb-4" />
                                <div class="mb-4">
                                    <label for="capital"
                            ...
                            <div class="mb-4 mt-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
